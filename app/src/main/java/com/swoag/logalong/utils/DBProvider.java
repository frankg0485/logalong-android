...
public class DBProvider extends ContentProvider {
    ...
    public static final Uri URI_TRANSACTION = Uri.parse("content://" + PROVIDER_NAME + "/" + TRANSACTIONS);
    public static final Uri URI_TRANSACTION_ACCOUNT = Uri.parse("content://" + PROVIDER_NAME + "/" + TRANSACTIONS_ACCOUNT);
    public static final Uri URI_TRANSACTION_CATEGORY = Uri.parse("content://" + PROVIDER_NAME + "/" + TRANSACTIONS_CATEGORY);
    public static final Uri URI_TRANSACTION_TAG = Uri.parse("content://" + PROVIDER_NAME + "/" + TRANSACTIONS_TAG);
    public static final Uri URI_TRANSACTION_VENDOR = Uri.parse("content://" + PROVIDER_NAME + "/" + TRANSACTIONS_VENDOR);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (table0 != null) {
            ...
            if (uriMatcher.match(uri) == TRANSACTIONS_ID) notifyTransactionChange();
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (table0 != null) {
            ...
            if (row > 0) {
                Uri uri1 = ContentUris.withAppendedId(uri0, row);
    ...
    private void notifyTransactionChange() {
        getContext().getContentResolver().notifyChange(URI_TRANSACTION_ACCOUNT, null);
        getContext().getContentResolver().notifyChange(URI_TRANSACTION_CATEGORY, null);
        getContext().getContentResolver().notifyChange(URI_TRANSACTION_TAG, null);
        getContext().getContentResolver().notifyChange(URI_TRANSACTION_VENDOR, null);
    }
}
