...
public class LTransport {
    ...
    public static boolean send_rqst(LAppServer server, short rqst, int datai, byte[] datab, int scrambler) {
        LBuffer buf = server.getNetBuffer();
        if (buf == null) return false;
        buf.putShortAutoInc(LProtocol.PACKET_SIGNATURE1);
        buf.putShortAutoInc((short) 0);
        buf.putShortAutoInc(rqst);
        buf.putIntAutoInc(datai);
        buf.putBytesAutoInc(datab, 0, datab.length);
    ...
    public static boolean send_rqst(LAppServer server, short rqst, int datai, int datai2, short length, byte[] datab,
                                    int offset, short bytes, int scrambler) {
        LBuffer buf = server.getNetBuffer();
        if (buf == null) return false;
        buf.putShortAutoInc(LProtocol.PACKET_SIGNATURE1);
        buf.putShortAutoInc((short) 0);
    ...
    public static boolean send_rqst(LAppServer server, short rqst, int data1, short data2, short data3, int scrambler) {
        LBuffer buf = server.getNetBuffer();
        if (buf == null) return false;
        ...
        buf.putShortAutoInc(rqst);
        buf.putIntAutoInc(data1);
        buf.putShortAutoInc(data2);
        buf.putShortAutoInc(data3);
        buf.setLen(16);
